    ...
    <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12"> 
        <div class="tab-content">
            ...
            <div class="tab-pane fade active in" id="Products">
                <h3 class="title-inner-section">Paylaşılan Ürünler</h3>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-4 col-xs-6">
                            <div class="more-product-item">
                                <div class="more-product-item-img">
                                    <img style="width: 100%; height: 90px;" src="<?php echo $uruncek['urunfoto_resimyol'] ?>" alt="product" class="img-responsive">
                                </div>

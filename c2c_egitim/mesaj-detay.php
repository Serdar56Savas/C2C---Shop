...
$mesajsor=$db->prepare("SELECT mesaj.*,kullanici.* FROM mesaj INNER JOIN kullanici ON mesaj.kullanici_gon=kullanici.kullanici_id where mesaj.kullanici_gon=:id and mesaj.mesaj_id=:mesaj_id order by mesaj_okunma,mesaj_zaman DESC");
                        ...
                        <div class="tab-pane fade active in" id="Personal">
                            ...
                            <div class="personal-info inner-page-padding"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <p><?php echo html_entity_decode( $mesajcek['mesaj_detay'] ) ?></p>
                                    </div>
                                </div>
                                ...
                                if ($_GET['gidenmesaj']!="ok") { ?>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div align="right" class="col-sm-12">
                                        ...
                                        <button class="update-btn" name="mesajcevapver" id="login-update">Mesajı Gönder</button>
                                    </div>
                                </div> 

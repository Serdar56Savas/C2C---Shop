                  ...
                  <div class="tab-pane fade active in" id="Personal">
                    ...
                    <div class="personal-info inner-page-padding"> 
                      ...
                      <div class="form-group">
                        <label class="col-sm-3 control-label">Puanınız</label>
                        <div class="col-sm-9">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-9">
                          <textarea style="height:200px; " class="form-control" name="yorum_detay" placeholder="Lütfen Yorumunuzu Giriniz..."   required="" type="text"></textarea>
                        </div>
                      </div>

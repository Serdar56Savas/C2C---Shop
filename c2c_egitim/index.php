...
<div class="main-banner2-area">
    <div class="container">
        <div class="main-banner2-wrapper">                       
            <h1>Savaş Akademi Markete Hoşgeldiniz</h1>
            <p>Aramak İstediğiniz Üründen Bir kaç Kelime ile Bahseder Misiniz ?</p>
        ...
        while($uruncek=$urunsor->fetch(PDO::FETCH_ASSOC)) { ?>
            ...
            <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 yenigelen plugins">
                <div class="single-item-grid">
                    <div class="item-img">
                        <a href="urun-<?=seo($uruncek['urun_ad'])."-".$uruncek['urun_id'] ?>"><img style="width: 350px; height: 200px;" src="<?php echo $uruncek['urunfoto_resimyol'] ?>" alt="product" class="img-responsive"></a>
